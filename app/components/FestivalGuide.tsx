...
export default function FestivalGuide() {
  ...
  return (
    <section className="py-24 px-6 bg-gradient-to-br from-gray-800 via-gray-900 to-black relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            {tips.map((tip, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gray-800/40 backdrop-blur-sm border border-gray-700/50 rounded-3xl p-6 hover:bg-gray-700/40 transition-all duration-300"
              >
                <div className="text-4xl mb-4">{tip.icon}</div>
                <h3 className="text-white font-bold text-xl mb-3">{tip.title}</h3>
        ...
        {activeTab === 'dress' && (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {dressCodeIdeas.map((category, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-sm border border-gray-700/50 rounded-3xl p-8"
                >
            ...
            >
              <div className="bg-gradient-to-r from-festival-pink/20 to-festival-orange/20 backdrop-blur-sm border border-festival-pink/30 rounded-2xl p-8 max-w-2xl mx-auto">
